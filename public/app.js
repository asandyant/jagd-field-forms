...
function buildIncidentPrint(){
  ...
  document.title=`Incident Report - ${dateToDisplay(val('irReportDate'))} - ${cleanFilePart(projectValue('irProject'))}`; setPrint(html + photoPages);
}
...
function buildHeavyAccidentPrint(){
  ...
  document.title=`Accident Report - ${dateToDisplay(val('harReportDate'))} - ${cleanFilePart(projectValue('harProject'))}`; setPrint(html + photoPages);
}
