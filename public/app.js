  ...
  app.innerHTML=`<div class="container tmShell">
    ...
    <section id="tmFormPanel" class="panel tmPanel">
      ...
      <div class="tmGrid">
        ...
        ${tmSelectField('tmType','Record type *','<option>Receipt / Materials</option><option>Rental</option><option>JAGD-Owned Equipment</option><option>Other Support Document</option>')}
        ...
        ${tmSelectField('tmCategory','Category *','<option>Materials</option><option>Small Tools</option><option>Consumables</option><option>Fuel</option><option>Safety Supplies</option><option>Equipment Repair</option><option>Rental</option><option>Delivery / Freight</option><option>Warehouse Stock</option><option>Other</option>')}
        ${tmSelectField('tmPayment','Paid with *','<option>Company AmEx</option><option>Company Credit Card</option><option>Personal Card - Reimbursement Needed</option><option>Cash</option><option>Vendor Account</option><option>Unknown</option>')}
      ...
      <section id="tmRentalBox" class="tmSubPanel hidden"><h3>Rental Details</h3><div class="tmGrid">${tmInputField('tmRentalEquipment','Equipment *')}${tmInputField('tmRentalUnit','Unit / contract #')}${tmInputField('tmRentalStart','Start date','date')}${tmInputField('tmRentalEnd','Expected return date','date')}${tmSelectField('tmRentalRateType','Rate type','<option>Daily</option><option>Weekly</option><option>Monthly</option>')}${tmInputField('tmRentalRate','Rate','number')}</div></section>
      <section id="tmOwnedBox" class="tmSubPanel hidden"><h3>JAGD-Owned Equipment</h3><div class="tmGrid">${tmInputField('tmEquipmentId','Equipment ID')}${tmInputField('tmEquipmentDescription','Equipment description')}${tmInputField('tmInUse','In-use hours','number')}${tmInputField('tmStandby','Standby hours','number')}${tmInputField('tmOwnershipRate','Ownership rate','number')}${tmInputField('tmOperatingRate','Operating rate','number')}</div></section>
